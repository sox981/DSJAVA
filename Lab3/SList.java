...
public class SList {
  ...
  public void insertFront(Object obj) {
    SListNode node = new SListNode(obj); //node is a temparary node whic is
                                         // build everytime when insertFront or
                                         //insertEnd
    if(size ==0){
      this.head = node;
      this.tail = node;
  ...
  public static void main (String[] args) {
    ...
    System.out.println("Here is a list after insertFront(3) & insertEnd(15) to list: "+ lst.toString());
